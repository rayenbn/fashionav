            ...
            <form action="{{ route("admin.category.update", [$category->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body" id="english-form">
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('en_category_name') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="en_category_name" name="en_category_name" class="form-control" value="{{ old('category_name', isset($category) ? $category->translate('en')->category_name : '') }}">
                ...
                <div class="card-body d-none" id="spanish-form">
                    <div class="form-group {{ $errors->has('es_category_name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="es_category_name" name="es_category_name" class="form-control" value="{{ old('category_name', isset($category) ? $category->translate('es')->category_name : '') }}">
                        @if($errors->has('category_name'))
                        <em class="invalid-feedback">
                            {{ $errors->first('category_name') }}
                        </em>
