...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('global.color') }}
    </div>
    ...
    <form action="{{ route("admin.color.update", [$color->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body"  id="english-form">
            <div class="form-group {{ $errors->has('en_color_name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="en_color_name" name="en_color_name" class="form-control" value="{{ old('en_color_name', isset($color) ? $color->translate('en')->color_name : '') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="color_code" name="color_code" data-original-title="" title="" value="{{ old('color_code', isset($color) ? $color->color_code : '') }}">
        ...
        <div class="card-body d-none" id="spanish-form">
            <div class="form-group {{ $errors->has('es_color_name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="es_color_name" name="es_color_name" class="form-control" value="{{ old('es_color_name', isset($color) ?  $color->translate('es')->color_name : '') }}">
                @if($errors->has('color_name'))
                    <em class="invalid-feedback">
                        {{ $errors->first('color_name') }}
                    </em>
